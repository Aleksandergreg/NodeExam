<script>
	...
	/**
	 * Parses a comment string to check if it's a Q&A format.
	 * @param {string} commentText The full text of the comment.
	 * @returns {{isQA: boolean, question?: string, answer?: string, text?: string}}
	 */
...
.comment-body p {
    margin: 0;
    white-space: pre-wrap; /* Respect newlines in standard comments */
}
